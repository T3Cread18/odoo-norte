...
class SaleOrder(models.Model):
    ...
    total_cost = fields.Float(string='Costo', compute='_compute_total_cost', store=True)
...
class SaleOrderCommission(models.Model):
    ...
    commission = fields.Float(string='Comisión', related='opportunity_id.commission', store=True)
